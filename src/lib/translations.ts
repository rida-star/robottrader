export const translations = {
  da: {
    ...
    landing: {
      ...
      getStartedSubtitle: "Udforsk de 5 hovedområder og find ud af, hvad du kan gøre på platformen",
      feature1Title: "Oversigt",
      feature1Desc: "Din personlige dashboard hvor du kan se og administrere alle dine oprettede robotter. Hold styr på dine projekter og fortsæt hurtigt hvor du slap.",
      feature2Title: "Robot Builder",
      feature2Desc: "Byg din egen handelsrobot trin for trin uden at skrive kode. Vælg strategi, definer regler og få genereret MT4/MT5 kode automatisk.",
      feature3Title: "Lær",
      feature3Desc: "Læringscenteret med artikler og guides om algoritmisk trading. Forstå grundlæggende begreber, strategier og risikostyring.",
      feature4Title: "Support",
      feature4Desc: "Har du spørgsmål eller brug for hjælp? Kontakt os via support-formularen eller find svar i vores FAQ-sektion.",
      feature5Title: "Blog",
      feature5Desc: "Læs artikler om trading, robotter, automatisering og få indsigt i markedets muligheder og faldgruber.",
    },
    // Auth
    auth: {
  ...
  en: {
    ...
    landing: {
      ...
      getStartedSubtitle: "Explore the 5 main areas and discover what you can do on the platform",
      feature1Title: "Dashboard",
      feature1Desc: "Your personal dashboard where you can see and manage all your created robots. Keep track of your projects and quickly continue where you left off.",
      feature2Title: "Robot Builder",
      feature2Desc: "Build your own trading robot step by step without writing code. Choose a strategy, define rules, and get MT4/MT5 code generated automatically.",
      feature3Title: "Learn",
      feature3Desc: "The learning center with articles and guides about algorithmic trading. Understand basic concepts, strategies, and risk management.",
      feature4Title: "Support",
      feature4Desc: "Have questions or need help? Contact us via the support form or find answers in our FAQ section.",
      feature5Title: "Blog",
      feature5Desc: "Read articles about trading, robots, automation and gain insight into market opportunities and pitfalls.",
    },
    // Auth
    auth: {
